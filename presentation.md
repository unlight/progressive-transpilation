...
# Agenda
* Cost of Transpiling
* Few issues on the road to ES2015 in production
* Progressive Transpiling
* Impacts
???
...
Здесь показана User Agent строка от Edge браузера, и для парсеров и это информация как бы говорит парсеру, если ты не знаешь об edge,
